...
// RENDERIZAR INICIAL
    ...
    try {
        ...
        // ✅ CAMBIO: Solicitamos SÓLO los productos en liquidación
        // En lugar de /hoja2
        ...
        // ----------------------------------------------------------
        // 🔍 FILTRADO (¡YA NO ES NECESARIO!)
        // ----------------------------------------------------------
        
        // Normalizamos los productos (esto SIEMPRE es necesario)
        const normalizados = data.map(normalizeProducto);

        // ✅ CAMBIO: El backend ya filtró. Solo asignamos los datos.
...
// ----------------------------------------------
// 🧩 ORDENADOR DE PRECIO (Sin cambios)
// ----------------------------------------------
